...
//			System.out.println(retStr);
	...
	public static void main(String[] args) {
		String retStr = materialSearch("夏装",1l,20l);

		MaterialSearchVo materialSearchVo = GsonUtil.GsonToBean(retStr, MaterialSearchVo.class);
		System.out.println(materialSearchVo.getTbk_dg_material_optional_response().getResult_list().getMap_data().get(0).getCoupon_share_url());

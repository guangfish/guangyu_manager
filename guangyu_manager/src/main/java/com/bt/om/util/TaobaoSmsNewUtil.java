...
public class TaobaoSmsNewUtil {
	private static final String product = "Dysmsapi";
	private static final String domain = "dysmsapi.aliyuncs.com";
	private static final String accessKeyId = "LTAI2BJ4Qh5oAqRA";
	private static final String accessKeySecret = "4hzaZBHc3P7Ag2yYl4FpUG7p6SctKR";
	...
	public static void sendSms(String signName, String smsTemplateCode, String var, String name, String mobile) {
		try {
			...
			request.setTemplateParam("{" + var + ":'" + name + "'}");

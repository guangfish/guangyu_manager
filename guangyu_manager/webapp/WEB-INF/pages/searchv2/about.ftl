		...
		<div class="mui-main-event">
			<div id="pullrefresh" class="mui-scroll-wrapper scroll-refresh">
				<div class="mui-scroll">
					<div id="faq" class="mui-event-cont">
						<div class="mui-cont-box">
							<a style="text-decoration: none;" href="#">
								...
								<div class="mui-cont-text">
									1、全品类搜索，只要淘宝、京东的商品有券或返现，逛鱼都能搜；<br/>2、其他类似APP根据商品标题搜索，搜索出的结果会很多，不能实现精确搜索；逛鱼可以，逛鱼会精确搜索出您想买的商品；<br/>3、逛鱼不是商城，也不是商店，更不是导购网站；您想买东西也不会第一个想到逛鱼对吧？<br/>
									4、APP很小、不占用您过多的磁盘空间，操作简单易懂；<br/>5、安全、不搜集用户信息；无广告，不扰民；<br/>6、更重要的，返现力度同类型APP中最高，不信？你去对比试试；<br/>								
								</div>								
							</a>
						</div>							
					</div>

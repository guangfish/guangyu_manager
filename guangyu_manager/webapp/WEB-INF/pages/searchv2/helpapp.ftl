...
<head>
	...
	<meta name="description" content="搜索淘宝、京东所有商品返利信息，帮助用户节省每一分钱。【花钱也能赚钱、让逛鱼带你飞】"/>
	<meta name="keywords" content="逛鱼搜索,逛鱼网,逛鱼返利,返利,折扣 ,佣金 ,淘宝,天猫 ,京东,消费 ,优惠 ,discounts, promotions,coupons"/>
					...
					<div id="taobao" class="mui-event-cont">
					    <div class="mui-cont-box">
							<a style="text-decoration: none;" href="#">
								...
								<div class="eventImg"><img class="eventImg" src="http://help.guangfish.com/imgs/app-help-tb-1.jpg" alt=""></div>	
								<div style="height:0.2rem;"></div>
								<div class="eventImg"><img class="eventImg" src="http://help.guangfish.com/imgs/app-help-tb-2.jpg" alt=""></div>							
							</a>
						</div>
						<div class="mui-cont-box">
							<a style="text-decoration: none;" href="#">
								...
								<div style="height:0.4rem;"></div>
								<div class="eventImg"><img class="eventImg" src="http://help.guangfish.com/imgs/app-help-tb-3.jpg" alt=""></div>								
							</a>
						</div>
						<div class="mui-cont-box">
							<a style="text-decoration: none;" href="#">
								...
								<div style="height:0.4rem;"></div>
								<div class="eventImg"><img class="eventImg" src="http://help.guangfish.com/imgs/app-help-tb-4.jpg" alt=""></div>								
							</a>
						</div>
						<div class="mui-cont-box">
							<a style="text-decoration: none;" href="#">
								...
								<div style="height:0.4rem;"></div>
								<div class="eventImg"><img class="eventImg" src="http://help.guangfish.com/imgs/app-help-tb-5.jpg" alt=""></div>								
							</a>
						</div>																
					</div>
					<div id="jd" class="mui-event-cont disn">
						<div class="mui-cont-box">
							<a style="text-decoration: none;" href="#">
								...
								<div style="height:0.4rem;"></div>
								<div class="eventImg"><img class="eventImg" src="http://help.guangfish.com/imgs/app-help-jd-1.jpg" alt=""></div>								
							</a>
						</div>	
						<div class="mui-cont-box">
							<a style="text-decoration: none;" href="#">
					...
					<div id="faq" class="mui-event-cont disn">
						<div class="mui-cont-box">
							<a style="text-decoration: none;" href="#">
								...
								<div class="mui-cont-text">
									1、复制淘宝商品的链接或标题</br>
									2、打开逛鱼APP，自动弹出查询确认框，点击确定，自动搜索商品</br>
									3、如果精确搜索出一条商品，APP会自动帮助你打开淘宝</br>
									4、打开淘宝后会弹出商品弹出框，点击打开按钮</br>
									5、完成商品购买，复制商品订单号</br>
									6、打开逛鱼APP，确认订单号并提交绑定</br>
								...
								<div class="mui-cont-text">
								    跑单的几种情况：<br/><br/>
									1、领券后从返利网购买！<br/>2、使用支付宝红包奖励金购买！<br/>3、看了宝贝后当时没买，收藏了，从收藏夹购买！<br/>
									4、领券了后当时没买，后面从曾经浏览宝贝里面购买！<br/>5、与店铺优惠活动叠加使用！<br/>6、使用集分宝购买！<br/>7、使用淘金币购买！<br/>8、农村淘宝！
									<br/><br/>总之，佣金奖励不能和其他优惠同时享受，佣金也一般是比店铺红包、集分宝等优惠是要高出几倍甚至几十倍的。很多小伙伴在支付时候，使用了集分宝、淘金币、支付宝红包等，实际上，你往往为了几毛钱的优惠，损失几块钱甚至几十块的佣金。
									<br/><br/>所以，领券后，尽量直接付款，在半小时时间内支付完成就好了。
								</div>								
							</a>
						</div>							
					</div>

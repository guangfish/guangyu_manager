...
<link rel="stylesheet" type="text/css" href="/static/frontv2/css/answer/answer.css">
			...
			<#else>
			  <div id="pullTips" class="mui-pull-tips"><div class="mui-pull-caption">去邀请朋友成为你的会员吧！<a href="/v2/invitation"><font color="red">点我邀请</font></a></div></div>
			          ...
			          <#list invitationList as invitation>
						<div class="main-answer-item">
							<p>${invitation.beInviterMobile?if_exists}&nbsp;<font color="red">(<#if (invitation.status==1)>未激活<#else>已激活</#if>)</font><span><#if (invitation.status==1)>￥${invitation.money?if_exists}&nbsp;<font color="red">(可领取)</font><#else>￥${invitation.money?if_exists}&nbsp;<font color="red">(<#if (invitation.reward==1)>未领取<#else>已领取</#if>)</font></#if></i></span></p>							
						</div>	
					  </#list>
			          </#if>					
					</div>
	...
	<nav class="mui-bar mui-bar-tab new-bar">
		<a style="text-decoration: none;" class="mui-tab-item mui-active" href="<#if (reward>0)>/v2/rewarddraw<#else>javascript:void(0);</#if>">
	...
	<nav class="mui-bar mui-bar-tab new-bar">
		<a style="text-decoration: none;" class="mui-tab-item mui-active" href="javascript:void(0);">
			<span class="mui-icon mui-icon-draw"></span>
			<span class="mui-tab-label">提取邀请奖励</br>(请下载逛鱼APP提现)</span>
		</a>
	</nav>

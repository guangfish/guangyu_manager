					...
					<li class="mui-table-view-cell mui-media pos">
						<a target="_blank" onclick="drump('${productInfo.couponPromoLink?if_exists}')" href="javascript:void(0);">
							...
							<div class="mui-media-body">
								...
								<p style="margin-top: 10px"><span class="mui-inventory">现价:&nbsp;${productInfo.price?if_exists}元</span><span style="position: absolute;right: 0;text-align: center;" class="mui-adorn">月销量:&nbsp;${productInfo.monthSales?if_exists}件&nbsp;&nbsp;</span></p>
								<p style="margin-top: 10px"><span class="mui-inventory">券:&nbsp;${productInfo.couponMiane?if_exists}</span><span style="position: absolute;right: 0;text-align: center;" class="mui-inventory">余${productInfo.couponRest?if_exists}张&nbsp;&nbsp;</span></p>
							...
							if(list.couponMiane){
							  var myInner = '<a id="copy'+list.productId+'" target="_blank" onclick="'+func+'" href="javascript:void(0);">\
								...
								<div class="mui-media-body">\
									...
									<p style="margin-top: 10px"><span class="mui-bodycolor">现价:&nbsp;'+zkPrice+'元&nbsp<del>'+price+'元</del></span><span style="position: absolute;right: 0;text-align: center;" class="mui-adorn">月销量:&nbsp;<span class="mui-adorn">'+list.monthSales+'件&nbsp;&nbsp;</span></p>\
									<p style="margin-top: 10px"><span class="mui-inventory">券:&nbsp;'+list.couponMiane+'</span><span style="position: absolute;right: 0;text-align: center;" class="mui-adorn">余<span class="mui-inventory">'+couponRest+'张&nbsp;&nbsp;</span></p>\
									<div style="margin-top: 15px">\

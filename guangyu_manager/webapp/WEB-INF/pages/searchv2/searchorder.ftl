	...
	<div class="mui-content self-content-box">
		<div class="mui-main-common">
			<div class="mui-common-tit tab_links">
				...
				<a data-id="#complete" class="mui-event-tap">已结算</a>
				<a data-id="#pay" class="mui-event-tap">已付款</a>
				<a data-id="#novalid" class="mui-event-tap">已失效</a>
				<a data-id="#novalid" class="mui-event-tap">好友订单</a>
			</div>
			<div id="pullrefresh" class="mui-scroll-wrapper scroll-refresh">			    
				<div class="mui-scroll">
						...
						<div class="mui-cont-box ">
							<div class="mui-new-list">
							  <#if (canDrawOrderNum>0)>
							    <br/><div id="pullTips" class="mui-pull-tips"><div class="mui-pull-caption"><font color="red">${canDrawOrderNum?if_exists}</font>条可提现，可提现金额<font color="red">￥${tCommission?if_exists}</font>
							  <#if (friendNum>0)>
							         ，共邀请<font color="red">${friendNum?if_exists}</font>个好友，尚有激活邀请<font color="red">${friendNumValid?if_exists}</font>个，未激活邀请<font color="red">${friendNumNoValid?if_exists}</font>个，可提现奖励<font color="red">￥${reward?if_exists}</font>，未达提现要求奖励<font color="red">￥${rewardAll?if_exists}</font></div></div><br/><br/>
							  <#else>
							    </div></div><br/>
							  </#if>							      
							  </#if>
					...
					<div id="pay" class="mui-common-cont disn">
						<div class="mui-cont-box">
							<div class="mui-new-list">
							  <#if (uncanDrawOrderNum>0)><br/><div id="pullTips" class="mui-pull-tips"><div class="mui-pull-caption"><font color="red">${uncanDrawOrderNum?if_exists}</font>条暂不可提现，预估暂不可提现金额<font color="red">￥${tUCommission?if_exists}</font></div></div><br/></#if>
								<ul class="mui-table-view">		

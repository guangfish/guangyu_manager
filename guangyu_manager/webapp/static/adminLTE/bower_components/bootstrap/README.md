...
Editor preferences are available in the [editor com.jolly.atplan.flight.parent.config](https://github.com/twbs/bootstrap/blob/master/.editorconfig) for easy use in common text editors. Read more and download plugins at <http://editorconfig.org>.
